...
namespace SchVictorina.Engines
{
    ...
    public class EquationEngine// : BaseEngine
    {
        public static string GetEquation(int maxValue)
        {
            ...
            return $"x{MathUtilites.GetRandomOperator()}{random.Next(1, maxValue)}={random.Next(1, maxValue)}";
        }
        public static int RightAnswerForEquation(string equation)
        {
            ...
            var trimmedEquation = equation[(equation.IndexOf('=') - 1)..];
        ...
        public static TaskInfo GenerateQuestion()
        {
            ...
            return new TaskInfo
            {
                ...
                AnswerOptions = MathUtilites.GetAnswerOptions(RightAnswerForEquation(randomEquation), 5)
            };
        }
    }
}
